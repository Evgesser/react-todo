...
export const categoryKeywords: Record<string, Record<string, string[]>> = {
  ru: {
    groceries: [
      ...
      'яйцо', 'яйца', 'яички', 'майонез', 'кетчуп', 'соус', 'горчица', 'уксус', 'дрожжи', 'желатин', 'крахмал', 'специи', 'приправа', 'перец молотый', 'лавровый лист'
    ],
    fruits: [
    ...
    milk: ['молоко', 'кефир', 'йогурт', 'молочные', 'сметана', 'творог', 'сыр', 'масло сливочное', 'ряженка', 'простокваша', 'сливки', 'сырок', 'брынза', 'глазированный'],
    beverages: ['вода', 'водичка', 'сок', 'сочек', 'напиток', 'напитки', 'напиточек', 'вино', 'винцо', 'пиво', 'пивко', 'сода', 'лимонад', 'лимонадик', 'квас', 'энергетик', 'алкоголь', 'алко', 'минералка', 'газировка', 'кока-кола', 'пепси', 'спрайт'],
    meat: ['мясо', 'свинина', 'говядина', 'курица', 'бекон', 'стейк', 'фарш', 'колбаса', 'сосиски', 'индейка', 'баранина', 'сало', 'ветчина', 'карбонад', 'буженина', 'крылышки', 'грудка', 'филе', 'пастрами', 'балык', 'бастурма', 'сервелат', 'салями', 'сосисочки', 'сардельки', 'шпикачки'],
    grill: ['гриль', 'барбекю', 'шашлык', 'мангал', 'угли', 'шампуры', 'люля-кебаб', 'купаты'],
    fastfood: ['фастфуд', 'бургер', 'гамбургер', 'картофель фри', 'пицца', 'шаурма', 'суши', 'роллы', 'хот-дог', 'наггетсы', 'стрипсы'],
    restaurant: ['еда', 'блюдо', 'готовая еда', 'доставка', 'салат готовый', 'винегрет', 'оливье'],
    bakery: ['хлеб', 'булочка', 'выпечка', 'булки', 'пирог', 'торт', 'печенье', 'круассан', 'батон', 'хлебушек', 'лаваш', 'пирожок', 'пончик', 'кекс', 'пряники'],
    icecream: ['мороженое', 'пломбир', 'эскимо', 'сорбет', 'рожок', 'стаканчик', 'фруктовый лед'],
    coffee: ['кофе', 'капучино', 'латте', 'эспрессо', 'кофейня', 'чай', 'заварка', 'какао', 'горячий шоколад'],
    foodbank: ['крупа', 'рис', 'макароны', 'мука', 'запас', 'консервы', 'гречка', 'овсянка', 'сахар', 'соль', 'масло растительное', 'тушенка', 'подсолнечное', 'оливковое', 'горох', 'чечевица', 'фасоль консервированная', 'маука', 'кускус', 'булгур', 'спагетти', 'вермишель', 'перловка', 'пшено', 'манка', 'сода пищевая', 'уксус'],
    health: ['аптека', 'лекарство', 'таблетки', 'витамины', 'мазь', 'пластырь', 'градусник', 'болит', 'бинт', 'анальгин', 'терафлю', 'парацетамол', 'аспирин', 'бинты', 'вата', 'перекись'],
    pets: ['животные', 'корм', 'собака', 'кошка', 'наполнитель', 'кот', 'пес', 'поводок', 'ошейник', 'кошачий', 'собачий', 'вискас', 'педигри'],
    baby: ['дети', 'ребенок', 'памперсы', 'подгузники', 'игрушки', 'соска', 'малыш', 'пюре детское', 'смесь', 'детское питание', 'хаггис', 'памперс'],
    sports: ['спорт', 'фитнес', 'мяч', 'тренировка', 'зал', 'гантели', 'протеин', 'коврик', 'скакалка', 'эспандер'],
    car: ['машина', 'авто', 'запчасти', 'масло', 'шины', 'мойка', 'колесо', 'омывайка', 'антифриз', 'незамерзайка', 'щетки стеклоочистителя'],
    frozen: ['заморозка', 'замороженные', 'пельмени', 'вареники', 'пицца замороженная', 'лед', 'овощи замороженные', 'полуфабрикаты', 'котлеты замороженные', 'наггетсы', 'блинчики', 'хинкали', 'манты'],
    snacks: ['снеки', 'снечки', 'чипсы', 'чипсики', 'сухарики', 'орехи', 'орешки', 'крекеры', 'попкорн', 'закуска', 'закусочка', 'сухофрукты', 'батончик', 'батончик', 'батончик', 'семечки', 'шоколад', 'конфеты', 'мармелад', 'зефир', 'халва'],
    seafood: ['рыба', 'морепродукты', 'креветки', 'кальмары', 'мидии', 'лосось', 'тунец', 'икра', 'осьминог', 'краб', 'море'],
  },
  en: {
    groceries: [
      ...
      'eggs', 'egg', 'mayonnaise', 'ketchup', 'sauce', 'mustard', 'vinegar', 'yeast', 'gelatin', 'starch', 'spices', 'seasoning', 'black pepper', 'bay leaf'
    ],
    fruits: [
    ...
    milk: ['milk', 'dairy', 'kefir', 'yogurt', 'sour cream', 'cottage cheese', 'cheese', 'butter', 'cream', 'whipped cream', 'margarine', 'condensed milk'],
    beverages: ['juice', 'juicy', 'drink', 'drinks', 'water', 'wine', 'beer', 'soda', 'lemonade', 'lemonadey', 'soft drink', 'energy drink', 'alcohol', 'alco', 'cocktail', 'mocktail', 'beverage', 'beverages', 'cola', 'pepsi', 'sprite', 'mineral water', 'sparkling water'],
    meat: ['meat', 'chicken', 'pork', 'beef', 'bacon', 'steak', 'minced meat', 'sausage', 'turkey', 'ham', 'pastrami', 'salami', 'lamb', 'ribs', 'wings', 'breast', 'fillet'],
    grill: ['grill', 'barbecue', 'bbq', 'charcoal', 'skewers', 'kebab'],
    fastfood: ['fastfood', 'burger', 'pizza', 'sushi', 'rolls', 'fries', 'hot dog', 'nuggets', 'strips'],
    restaurant: ['restaurant', 'meal', 'prepared food', 'delivery', 'salad', 'soup'],
    bakery: ['cake', 'bread', 'bakery', 'pastry', 'pie', 'cookies', 'croissant', 'bagel', 'bun', 'muffin', 'donut'],
    icecream: ['icecream', 'ice-cream', 'sorbet', 'popsicle', 'cone', 'sundae'],
    coffee: ['coffee', 'cafe', 'tea', 'cappuccino', 'latte', 'espresso', 'cocoa', 'hot chocolate'],
    foodbank: ['grains', 'rice', 'pasta', 'flour', 'canned', 'canned goods', 'sugar', 'salt', 'oil', 'buckwheat', 'couscous', 'bulgur', 'spaghetti', 'noodles', 'sunflower oil', 'olive oil'],
    health: ['pharmacy', 'medicine', 'pills', 'vitamins', 'ointment', 'bandaid', 'drug', 'health', 'bandage', 'aspirin', 'paracetamol', 'ibuprofen'],
    pets: ['pets', 'food', 'dog', 'cat', 'litter', 'puppy', 'kitten', 'leash', 'collar', 'pet food'],
    baby: ['baby', 'child', 'diapers', 'toys', 'pacifier', 'wipes', 'baby food', 'formula', 'pampers', 'huggies'],
    sports: ['sports', 'fitness', 'ball', 'workout', 'gym', 'training', 'protein', 'dumbbells', 'mat', 'jump rope'],
    car: ['car', 'auto', 'parts', 'oil', 'tires', 'wash', 'wheel', 'antifreeze', 'washer fluid', 'wipers'],
    frozen: ['frozen', 'frozen food', 'dumplings', 'frozen pizza', 'ice', 'frozen vegetables', 'semi-finished', 'nuggets', 'ravioli'],
    snacks: ['snack', 'snacks', 'snacky', 'chips', 'chip', 'crisps', 'crisp', 'nuts', 'nut', 'crackers', 'cracker', 'popcorn', 'corn', 'dried fruit', 'fruit bar', 'bar', 'snacklet', 'snackling', 'chocolate', 'candy', 'seeds', 'marshmallow'],
  ...
  he: {
    groceries: [
      ...
      'ביצים', 'ביצה', 'מיונז', 'קטשופ', 'רוטב', 'חרדל', 'חומץ', 'שמרים', 'ג\'לטין', 'עמילן', 'תבלינים', 'תבלין', 'פלפל שחור', 'עלה דפנה'
    ],
    fruits: [
    ...
    milk: ['חלב', 'יוגורט', 'מוצרי חלב', 'שמנת חמוצה', 'גבינה', 'קוטג\'', 'חמאה', 'יוגורט', 'שמנת', 'גבינה צהובה', 'גבינת לבנה', 'קפיר', 'ריוויון', 'שוקו', 'מעדן'],
    beverages: ['מים', 'מיץ', 'משקה', 'יין', 'בירה', 'סודה', 'לימונדה', 'משקה קל', 'משקה אנרגיה', 'אלכוהול', 'קולה', 'פפסי', 'ספרייט', 'מינרלים', 'סודה לשתייה', 'קוקטייל', 'מיץ תפוזים'],
    meat: ['בשר', 'חזיר', 'בקר', 'עוף', 'בייקון', 'סטייק', 'בשר טחון', 'נקניק', 'הודו', 'פסטרמה', 'סלמי', 'נקניקיות', 'כנפיים', 'שניצל', 'כרעיים', 'נתח'],
    grill: ['גריל', 'ברביקיו', 'מנגל', 'פחמים', 'שיפודים', 'על האש', 'סטייקים', 'המבורגרים', 'קבב', 'פרגית'],
    fastfood: ['אוכל מהיר', 'המבורגר', 'פיצה', 'סושי', 'רולים', 'צ\'יפס', 'נאגטס', 'טוסט', 'שווארמה', 'פלאפל', 'בוריטו'],
    restaurant: ['אוכל', 'מנה', 'אוכל מוכן', 'משלוח', 'סלט', 'מרק', 'מסעדה', 'טייק אווי'],
    bakery: ['לחם', 'עוגה', 'מאפה', 'מאפים', 'פאי', 'עוגיות', 'קרואסון', 'לחמנייה', 'בייגלה', 'בורקס', 'חלה', 'מאפינס', 'דונאטס'],
    icecream: ['גלידה', 'ארטיק', 'סורבה', 'שלגון', 'גביע', 'טילון'],
    coffee: ['קפה', 'קפוצ׳ינו', 'לאטה', 'אספרסו', 'בית קפה', 'תה', 'שוקו', 'נס קפה', 'קסטה', 'מקיאטו'],
    foodbank: ['דגנים', 'אורז', 'פסטה', 'קמח', 'מלאי', 'שימורים', 'כוסמת', 'סוכר', 'מלח', 'שמן', 'גרגירים', 'עדשים', 'שעועית', 'קינואה', 'בורגול', 'ספגטי', 'קוסקוס'],
    health: ['בית מרקחת', 'תרופה', 'כדורים', 'ויטמינים', 'משחה', 'פלסטר', 'בריאות', 'תחבושת', 'אקמול', 'אופטלגין', 'אנטיביוטיקה', 'סירופ'],
    pets: ['חיות מחמד', 'אוכל לכלבים', 'כלב', 'חתול', 'חול', 'חיות', 'רצועה', 'קולר', 'אוכל לחתולים', 'חטיף לכלב', 'עצם'],
    baby: ['תינוק', 'ילד', 'חיתולים', 'צעצועים', 'מוץ', 'מגבונים', 'אוכל לתינוקות', 'פורמולה', 'מטרנה', 'סימילאק', 'פמפרס', 'האגיס'],
    sports: ['ספורט', 'כושר', 'כדור', 'אימון', 'חדר כושר', 'חלבון', 'משקולות', 'מזרן אימון', 'גומיות', 'שייקר'],
    car: ['רכב', 'אוטו', 'חלקים', 'שמן', 'צמיגים', 'שטיפה', 'גלגל', 'אנטיפריז', 'מגבים', 'נוזל קירור', 'פילטר'],
    frozen: ['קפוא', 'אוכל קפוא', 'כיסונים', 'פיצה קפואה', 'קרח', 'ירקות קפואים', 'חצי מבושל', 'נאגטס', 'מלווח', 'ג׳חנון', 'בורקס קפוא'],
    snacks: ['חטיפים', 'צ\'יפס', 'אגוזים', 'קרקרים', 'פופקורן', 'פירות יבשים', 'חטיף', 'במבה', 'ביסלי', 'שוקולד', 'סוכריות', 'מסטיק', 'גרעינים'],
